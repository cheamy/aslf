...
class Net(nn.Module):
    def __init__(self, angRes, angRes_out, factor):
        ...
        # self.epiFeatureRebuild_A = EpiFeatureRebuild_A(self.angRes, self.angRes_out, channels, feat_unfold=False)
        # self.epiFeatureRebuild_S = EpiFeatureRebuild_S(self.angRes, self.factor, channels, feat_unfold=False)
